...
export type Product = {
    id: number
    name: string
    category: 'cadenas' | 'anillos' | 'aretes' // solo puede ser uno de estos 
...
export const PRODUCTS: Product[] = [
  {
    id: 1,
    name: 'Cadena Cubana Clásica',
    category: 'cadenas',
    gender: 'hombre',
    price: 150000,
    description: 'Cadena cubana en oro laminado 18k, diseño clásico y resistente. Perfecta para uso diario.',
    image: '/images/abstract-gold-chain-jewellery-presentation.jpg',
  ...
  {
    id: 2,
    name: 'Anillo Solitario Elegante',
    category: 'anillos',
    gender: 'mujer',
    price: 95000,
    description: 'Hermoso anillo solitario con circonita brillante. Ideal para cualquier ocasión especial.',
    image: '/images/view-luxurious-golden-ring-with-marble.jpg',
    material: 'Oro laminado 18k',
    sizes: ['6', '7', '8', '9'],
  ...
  {
    id: 3,
    name: 'Aretes Argolla Mediana',
    category: 'aretes',
    gender: 'mujer',
    price: 75000,
    description: 'Aretes tipo argolla en oro laminado, diseño versátil que combina con todo.',
    image: '/images/feturedEarrings.jpg',
    material: 'Oro laminado 18k',
  ...
  {
    id: 4,
    name: 'Cadena Figaro Premium',
    category: 'cadenas',
    gender: 'hombre',
    price: 180000,
    description: 'Cadena estilo figaro, diseño moderno y sofisticado. Alta durabilidad.',
    image: '/images/beautiful-luxury-necklace-jewelry-stand-neck.jpg',
    material: 'Oro laminado 18k',
    sizes: ['55cm', '60cm', '65cm'],
    colors: ['Oro amarillo'],
    inStock: true,
    isFeatured: true,
    isNew: true,
  ...
  {
    id: 5,
    name: 'Anillo Alianza Matrimonial',
    category: 'anillos',
    gender: 'unisex',
    price: 120000,
    description: 'Alianza clásica perfecta para matrimonio o compromiso. Diseño atemporal.',
    image: '/images/wedding-rings-captured-with-reflection-surface.jpg',
    material: 'Oro laminado 18k',
    sizes: ['6', '7', '8', '9', '10'],
    colors: ['Oro amarillo', 'Oro blanco'],
    inStock: true,
    isFeatured: false,
    isNew: false,
    sku: 'ANI-ALI-001'
  ...
  {
    id: 6,
    name: 'Aretes Perla Elegante',
    category: 'aretes',
    gender: 'mujer',
    price: 65000,
    description: 'Aretes con perla cultivada, elegancia pura para ocasiones especiales.',
    image: '/images/aesthetic-golden-earrings-with-pearls.jpg',
    material: 'Oro laminado 18k',
    colors: ['Oro amarillo'],
    inStock: false,
    isFeatured: false,
